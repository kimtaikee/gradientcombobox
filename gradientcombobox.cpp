...
GradientWidgetItem::GradientWidgetItem(const GradientData &gradient, QWidget* parent) : QWidget(parent), m_gradientData(gradient)
{
...
GradientLabel::GradientLabel(QWidget *parent) : QLabel(parent)
{
